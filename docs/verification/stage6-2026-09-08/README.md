...
**Актуальное состояние после аудита:** [исправления и повторные проверки](fixes/README.md).
GC сохраняет inbox/operations и paused jobs. REL-03 ожидает CORE-05: максимальный
срок redelivery и безопасную очистку квитанций. L-01 дополнен работающими workers,
L-03 — реальными HTTP/mTLS-соединениями.
