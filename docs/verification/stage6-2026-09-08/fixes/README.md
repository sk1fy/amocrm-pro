...
**Исторический отчёт до CORE-05.** Описанный ниже отказ от GC inbox/operations
и ожидание календарного redelivery заменены реализацией этапа 7: семь суток,
terminal GC и tombstones. Актуальный статус: [REL-03](../rel-03.md),
[проверки этапа 7](../../stage7-2026-09-08/fixes/README.md). Старые логи и
результаты нагрузочных измерений сохранены без приписывания им новых проверок.
