...
Этот каталог содержит завершённые датированные планы. Они объясняют исходный
scope и последовательность реализации, но не являются текущим backlog или
инструкцией по возобновлению работ.
...
в [`../adr/`](../adr/). Актуальный backlog ведётся в GitHub Issues.
