...
Частично заменено [ADR-0029](0029-outbound-budget-account-scope.md): ключ
бюджета интеграции стал парой `[account_id, integration_id]`, `burst` снижен
до 1, ожидание ограничено с отказом. Решение о единственном владельце
исходящего трафика и разбор 429 остаются в силе.
