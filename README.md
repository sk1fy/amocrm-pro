...
- widget action admission атомарно связывает одноразовый JWT, Idempotency-Key и
  PostgreSQL job; прикладные domain workflows и production hardening остаются
  следующими этапами.
...
[widget idempotency checkpoint](docs/project-memory/CHECKPOINT-2026-07-11-widget-idempotency.md).
